...
/**
 * @param {Ctx} ctx
 * @return {Promise<import('vscode').WebviewPanel>}
 */
function showGraph(ctx) {
	if (view) {
...
function initView(ctx, panel) {
	...
	view.webview.onDidReceiveMessage(e => handleWebViewEvent(ctx, e));
...
/**
 * @param {Ctx} ctx
 * @param {{type: string, [prop: string]: any}} e
 */
function handleWebViewEvent(ctx, e) {
	switch (e.type) {
	case 'ready':
